...
- **AI-Powered Analysis**: Generate insights using OpenAI's GPT-4.1-nano model
...
3. **AnalysisFormatter Node**: 
   - Generates structured stock reports using OpenAI's GPT-4.1-nano model
...
6. **RecommendationFormatting Node**: 
   - Uses OpenAI's GPT-4.1-nano to extract and format stock recommendations from research
